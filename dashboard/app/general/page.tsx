...
import { RefreshCw, ArrowUp, ArrowDown, SlidersHorizontal, Check, Stamp } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#F5F5F4] dark:bg-[#0f0f10]">
        ...
        <div className="px-4 md:px-6 py-3">
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              <h1 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">General Roles</h1>
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-20">
          <p className="text-sm text-zinc-400">No general roles yet. Pipeline runs daily at 8 AM IST.</p>
        </div>
      ) : (
        <>
          {/* ── Mobile card list ── */}
