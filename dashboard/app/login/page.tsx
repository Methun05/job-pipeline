    ...
    <div className="min-h-screen bg-[#F5F5F4] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-zinc-900">Job Tracker</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <input
            ...
            className="w-full bg-white border border-zinc-200 rounded-xl px-4 py-3 text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-violet-500 text-base shadow-sm"
            autoFocus
          />
